...
module VendingMachine(
  ...
  output       io_sold, // @[\\src\\main\\scala\\VendingMachine.scala 6:14]
  output       io_empty, // @[\\src\\main\\scala\\VendingMachine.scala 6:14]
  output       io_full, // @[\\src\\main\\scala\\VendingMachine.scala 6:14]
  output       io_rtnCoin // @[\\src\\main\\scala\\VendingMachine.scala 6:14]
);
`ifdef RANDOMIZE_REG_INIT
  reg [31:0] _RAND_0;
  reg [31:0] _RAND_1;
  ...
  reg [31:0] _RAND_21;
`endif // RANDOMIZE_REG_INIT
  wire [3:0] sevSegDecoder_io_in; // @[\\src\\main\\scala\\VendingMachine.scala 96:29]
  wire [6:0] sevSegDecoder_io_out; // @[\\src\\main\\scala\\VendingMachine.scala 96:29]
  wire  fsm_clock; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  fsm_reset; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  fsm_io_coin2Edge; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  fsm_io_coin5Edge; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  fsm_io_buyEdge; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  fsm_io_buy; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  fsm_io_coin2; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  fsm_io_coin5; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire [7:0] fsm_io_totalMoney; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire [7:0] fsm_io_itemPrice; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  fsm_io_inpCoinBeingRej; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  fsm_io_signalCoin2; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  fsm_io_signalCoin5; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  fsm_io_signalSub; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  fsm_io_releaseCan; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  fsm_io_alarm; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  fsm_io_coinBeingRejected; // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
  wire  uart_clock; // @[\\src\\main\\scala\\VendingMachine.scala 219:20]
  wire  uart_reset; // @[\\src\\main\\scala\\VendingMachine.scala 219:20]
  wire  uart_io_txd; // @[\\src\\main\\scala\\VendingMachine.scala 219:20]
  wire  uart_io_sold; // @[\\src\\main\\scala\\VendingMachine.scala 219:20]
  wire  uart_io_alarm; // @[\\src\\main\\scala\\VendingMachine.scala 219:20]
  wire  uart_io_empty; // @[\\src\\main\\scala\\VendingMachine.scala 219:20]
  wire  uart_io_full; // @[\\src\\main\\scala\\VendingMachine.scala 219:20]
  wire  uart_io_rtnCoin; // @[\\src\\main\\scala\\VendingMachine.scala 219:20]
  reg [7:0] totalMoney; // @[\\src\\main\\scala\\VendingMachine.scala 33:27]
  wire [7:0] _GEN_26 = totalMoney % 8'ha; // @[\\src\\main\\scala\\VendingMachine.scala 34:30]
  wire [3:0] onesDigit = _GEN_26[3:0]; // @[\\src\\main\\scala\\VendingMachine.scala 34:30]
  wire [7:0] _tensDigit_T = totalMoney / 4'ha; // @[\\src\\main\\scala\\VendingMachine.scala 35:31]
  wire [7:0] _GEN_46 = _tensDigit_T % 8'ha; // @[\\src\\main\\scala\\VendingMachine.scala 35:39]
  wire [3:0] tensDigit = _GEN_46[3:0]; // @[\\src\\main\\scala\\VendingMachine.scala 35:39]
  wire [4:0] _GEN_0 = 5'h9 == io_price ? 5'h11 : 5'h0; // @[\\src\\main\\scala\\VendingMachine.scala 40:13 41:20 50:25]
  wire [4:0] _GEN_1 = 5'h8 == io_price ? 5'ha : _GEN_0; // @[\\src\\main\\scala\\VendingMachine.scala 41:20 49:25]
  wire [4:0] _GEN_2 = 5'h7 == io_price ? 5'he : _GEN_1; // @[\\src\\main\\scala\\VendingMachine.scala 41:20 48:25]
  wire [4:0] _GEN_3 = 5'h6 == io_price ? 5'h14 : _GEN_2; // @[\\src\\main\\scala\\VendingMachine.scala 41:20 47:25]
  wire [4:0] _GEN_4 = 5'h5 == io_price ? 5'h12 : _GEN_3; // @[\\src\\main\\scala\\VendingMachine.scala 41:20 46:25]
  wire [4:0] _GEN_5 = 5'h4 == io_price ? 5'h11 : _GEN_4; // @[\\src\\main\\scala\\VendingMachine.scala 41:20 45:25]
  wire [4:0] _GEN_6 = 5'h3 == io_price ? 5'h7 : _GEN_5; // @[\\src\\main\\scala\\VendingMachine.scala 41:20 44:25]
  wire [4:0] _GEN_7 = 5'h2 == io_price ? 5'h4 : _GEN_6; // @[\\src\\main\\scala\\VendingMachine.scala 41:20 43:25]
  wire [4:0] _GEN_8 = 5'h1 == io_price ? 5'h4 : _GEN_7; // @[\\src\\main\\scala\\VendingMachine.scala 41:20 42:25]
  wire [7:0] itemPrice = {{3'd0}, _GEN_8}; // @[\\src\\main\\scala\\VendingMachine.scala 39:23]
  wire [7:0] _GEN_47 = itemPrice % 8'ha; // @[\\src\\main\\scala\\VendingMachine.scala 53:29]
  wire [3:0] priceOnes = _GEN_47[3:0]; // @[\\src\\main\\scala\\VendingMachine.scala 53:29]
  wire [7:0] _priceTens_T = itemPrice / 4'ha; // @[\\src\\main\\scala\\VendingMachine.scala 54:30]
  wire [7:0] _GEN_48 = _priceTens_T % 8'ha; // @[\\src\\main\\scala\\VendingMachine.scala 54:38]
  wire [3:0] priceTens = _GEN_48[3:0]; // @[\\src\\main\\scala\\VendingMachine.scala 54:38]
  reg [31:0] blinkCounter; // @[\\src\\main\\scala\\VendingMachine.scala 59:29]
  reg  blinkReg; // @[\\src\\main\\scala\\VendingMachine.scala 60:25]
  reg [31:0] cntReg; // @[\\src\\main\\scala\\VendingMachine.scala 63:23]
  reg [1:0] selReg; // @[\\src\\main\\scala\\VendingMachine.scala 64:23]
  reg [5:0] coin2Count; // @[\\src\\main\\scala\\VendingMachine.scala 68:27]
  reg [5:0] coin5Count; // @[\\src\\main\\scala\\VendingMachine.scala 69:27]
  wire  coinFull = coin2Count >= 6'h3f | coin5Count >= 6'h3f; // @[\\src\\main\\scala\\VendingMachine.scala 70:37]
  reg [3:0] fullDisplayCount; // @[\\src\\main\\scala\\VendingMachine.scala 71:33]
  wire  showFull = fullDisplayCount > 4'h0; // @[\\src\\main\\scala\\VendingMachine.scala 72:35]
  reg  REG; // @[\\src\\main\\scala\\VendingMachine.scala 90:58]
  wire  _T_10 = io_coin2 & ~REG; // @[\\src\\main\\scala\\VendingMachine.scala 90:47]
  reg  REG_1; // @[\\src\\main\\scala\\VendingMachine.scala 90:58]
  wire  _T_13 = io_coin5 & ~REG_1; // @[\\src\\main\\scala\\VendingMachine.scala 90:47]
  reg  REG_2; // @[\\src\\main\\scala\\VendingMachine.scala 77:28]
  wire [3:0] _fullDisplayCount_T_1 = fullDisplayCount - 4'h1; // @[\\src\\main\\scala\\VendingMachine.scala 78:42]
  reg [4:0] canCount; // @[\\src\\main\\scala\\VendingMachine.scala 83:25]
  wire  canEmpty = canCount == 5'h0; // @[\\src\\main\\scala\\VendingMachine.scala 84:27]
  reg  buyFallingEdge_REG; // @[\\src\\main\\scala\\VendingMachine.scala 85:42]
  wire  buyFallingEdge = ~io_buy & buyFallingEdge_REG; // @[\\src\\main\\scala\\VendingMachine.scala 85:32]
  reg  coin2Edge_REG; // @[\\src\\main\\scala\\VendingMachine.scala 90:58]
  wire  _coin2Edge_T_1 = io_coin2 & ~coin2Edge_REG; // @[\\src\\main\\scala\\VendingMachine.scala 90:47]
  wire  _coin2Edge_T_2 = ~canEmpty; // @[\\src\\main\\scala\\VendingMachine.scala 91:43]
  wire  _coin2Edge_T_4 = ~coinFull; // @[\\src\\main\\scala\\VendingMachine.scala 91:56]
  reg  coin5Edge_REG; // @[\\src\\main\\scala\\VendingMachine.scala 90:58]
  wire  _coin5Edge_T_1 = io_coin5 & ~coin5Edge_REG; // @[\\src\\main\\scala\\VendingMachine.scala 90:47]
  reg  buyEdge_REG; // @[\\src\\main\\scala\\VendingMachine.scala 90:58]
  wire  _buyEdge_T_1 = io_buy & ~buyEdge_REG; // @[\\src\\main\\scala\\VendingMachine.scala 90:47]
  reg [31:0] rejectCounter; // @[\\src\\main\\scala\\VendingMachine.scala 102:30]
  reg  rejectReg; // @[\\src\\main\\scala\\VendingMachine.scala 103:26]
  wire [31:0] _rejectCounter_T_1 = rejectCounter + 32'h1; // @[\\src\\main\\scala\\VendingMachine.scala 105:34]
  wire [31:0] _blinkCounter_T_1 = blinkCounter + 32'h1; // @[\\src\\main\\scala\\VendingMachine.scala 114:32]
  wire  _blinkReg_T = ~blinkReg; // @[\\src\\main\\scala\\VendingMachine.scala 117:17]
  wire  _T_21 = totalMoney <= 8'h61; // @[\\src\\main\\scala\\VendingMachine.scala 137:41]
  wire [5:0] _coin2Count_T_1 = coin2Count + 6'h1; // @[\\src\\main\\scala\\VendingMachine.scala 138:30]
  wire  _T_23 = totalMoney <= 8'h5e; // @[\\src\\main\\scala\\VendingMachine.scala 140:41]
  wire [5:0] _coin5Count_T_1 = coin5Count + 6'h1; // @[\\src\\main\\scala\\VendingMachine.scala 141:30]
  wire  _T_25 = buyFallingEdge & fsm_io_releaseCan; // @[\\src\\main\\scala\\VendingMachine.scala 144:23]
  wire [4:0] _canCount_T_1 = canCount - 5'h1; // @[\\src\\main\\scala\\VendingMachine.scala 145:26]
  reg  fsm_io_inpCoinBeingRej_REG; // @[\\src\\main\\scala\\VendingMachine.scala 150:36]
  wire [7:0] _totalMoney_T_1 = totalMoney + 8'h2; // @[\\src\\main\\scala\\VendingMachine.scala 154:32]
  wire [7:0] _totalMoney_T_3 = totalMoney + 8'h5; // @[\\src\\main\\scala\\VendingMachine.scala 160:32]
  wire  _GEN_21 = _T_23 ? 1'h0 : 1'h1; // @[\\src\\main\\scala\\VendingMachine.scala 159:30 149:31 162:18]
  wire [7:0] _totalMoney_T_5 = totalMoney - itemPrice; // @[\\src\\main\\scala\\VendingMachine.scala 165:30]
  wire  _GEN_24 = fsm_io_signalCoin5 & _GEN_21; // @[\\src\\main\\scala\\VendingMachine.scala 149:31 158:35]
  wire [31:0] _cntReg_T_1 = cntReg + 32'h1; // @[\\src\\main\\scala\\VendingMachine.scala 169:20]
  wire [1:0] _selReg_T_1 = selReg + 2'h1; // @[\\src\\main\\scala\\VendingMachine.scala 172:22]
  wire  blinkDuringAlarm = fsm_io_alarm & _blinkReg_T; // @[\\src\\main\\scala\\VendingMachine.scala 186:40]
  wire [3:0] _activeDigit_T = blinkDuringAlarm ? 4'hf : 4'h7; // @[\\src\\main\\scala\\VendingMachine.scala 191:25]
  wire [6:0] _GEN_29 = canEmpty ? 7'h79 : sevSegDecoder_io_out; // @[\\src\\main\\scala\\VendingMachine.scala 193:22 188:27 193:30]
  wire [6:0] _GEN_30 = showFull ? 7'h71 : _GEN_29; // @[\\src\\main\\scala\\VendingMachine.scala 194:{22,30}]
  wire [3:0] _activeDigit_T_1 = blinkDuringAlarm ? 4'hf : 4'hb; // @[\\src\\main\\scala\\VendingMachine.scala 197:25]
  wire [6:0] _GEN_31 = canEmpty ? 7'h73 : sevSegDecoder_io_out; // @[\\src\\main\\scala\\VendingMachine.scala 199:22 188:27 199:30]
  wire [6:0] _GEN_32 = showFull ? 7'h3e : _GEN_31; // @[\\src\\main\\scala\\VendingMachine.scala 200:{22,30}]
  wire [6:0] _GEN_33 = canEmpty ? 7'h78 : sevSegDecoder_io_out; // @[\\src\\main\\scala\\VendingMachine.scala 205:22 188:27 205:30]
  wire [6:0] _GEN_34 = showFull ? 7'h38 : _GEN_33; // @[\\src\\main\\scala\\VendingMachine.scala 206:{22,30}]
  wire [6:0] _GEN_35 = canEmpty ? 7'h6e : sevSegDecoder_io_out; // @[\\src\\main\\scala\\VendingMachine.scala 211:22 188:27 211:30]
  wire [6:0] _GEN_36 = showFull ? 7'h38 : _GEN_35; // @[\\src\\main\\scala\\VendingMachine.scala 212:{22,30}]
  wire [3:0] _GEN_37 = 2'h3 == selReg ? 4'he : 4'hf; // @[\\src\\main\\scala\\VendingMachine.scala 189:18 209:19 97:32]
  wire [3:0] _GEN_38 = 2'h3 == selReg ? priceOnes : 4'h0; // @[\\src\\main\\scala\\VendingMachine.scala 189:18 210:27 98:23]
  wire [6:0] _GEN_39 = 2'h3 == selReg ? _GEN_36 : sevSegDecoder_io_out; // @[\\src\\main\\scala\\VendingMachine.scala 189:18 188:27]
  wire [3:0] _GEN_40 = 2'h2 == selReg ? 4'hd : _GEN_37; // @[\\src\\main\\scala\\VendingMachine.scala 189:18 203:19]
  wire [3:0] _GEN_41 = 2'h2 == selReg ? priceTens : _GEN_38; // @[\\src\\main\\scala\\VendingMachine.scala 189:18 204:27]
  wire [6:0] _GEN_42 = 2'h2 == selReg ? _GEN_34 : _GEN_39; // @[\\src\\main\\scala\\VendingMachine.scala 189:18]
  wire [3:0] _GEN_43 = 2'h1 == selReg ? _activeDigit_T_1 : _GEN_40; // @[\\src\\main\\scala\\VendingMachine.scala 189:18 197:19]
  wire [3:0] _GEN_44 = 2'h1 == selReg ? onesDigit : _GEN_41; // @[\\src\\main\\scala\\VendingMachine.scala 189:18 198:27]
  wire [6:0] _GEN_45 = 2'h1 == selReg ? _GEN_32 : _GEN_42; // @[\\src\\main\\scala\\VendingMachine.scala 189:18]
  wire [6:0] segOut = 2'h0 == selReg ? _GEN_30 : _GEN_45; // @[\\src\\main\\scala\\VendingMachine.scala 189:18]
  reg  uart_io_empty_REG; // @[\\src\\main\\scala\\VendingMachine.scala 90:58]
  reg  uart_io_full_REG; // @[\\src\\main\\scala\\VendingMachine.scala 90:58]
  reg  uart_io_rtnCoin_REG; // @[\\src\\main\\scala\\VendingMachine.scala 90:58]
  SevenSegDec sevSegDecoder ( // @[\\src\\main\\scala\\VendingMachine.scala 96:29]
    .io_in(sevSegDecoder_io_in),
    .io_out(sevSegDecoder_io_out)
  );
  VendingFSM fsm ( // @[\\src\\main\\scala\\VendingMachine.scala 123:19]
    .clock(fsm_clock),
    .reset(fsm_reset),
  ...
  UartDisplay uart ( // @[\\src\\main\\scala\\VendingMachine.scala 219:20]
    .clock(uart_clock),
    .reset(uart_reset),
    .io_txd(uart_io_txd),
  ...
  assign io_releaseCan = fsm_io_releaseCan & _coin2Edge_T_2; // @[\\src\\main\\scala\\VendingMachine.scala 235:38]
  assign io_alarm = fsm_io_alarm & blinkReg; // @[\\src\\main\\scala\\VendingMachine.scala 236:28]
  assign io_rejectCoinLED = (fsm_io_coinBeingRejected | showFull) & rejectReg; // @[\\src\\main\\scala\\VendingMachine.scala 237:62]
  assign io_seg = ~segOut; // @[\\src\\main\\scala\\VendingMachine.scala 233:13]
  assign io_an = 2'h0 == selReg ? _activeDigit_T : _GEN_43; // @[\\src\\main\\scala\\VendingMachine.scala 189:18 191:19]
  assign io_txd = uart_io_txd; // @[\\src\\main\\scala\\VendingMachine.scala 230:10]
  assign io_sold = uart_io_sold; // @[\\src\\main\\scala\\VendingMachine.scala 238:11]
  assign io_empty = uart_io_empty; // @[\\src\\main\\scala\\VendingMachine.scala 239:12]
  assign io_full = uart_io_full; // @[\\src\\main\\scala\\VendingMachine.scala 240:11]
  assign io_rtnCoin = uart_io_rtnCoin; // @[\\src\\main\\scala\\VendingMachine.scala 241:14]
  assign sevSegDecoder_io_in = 2'h0 == selReg ? tensDigit : _GEN_44; // @[\\src\\main\\scala\\VendingMachine.scala 189:18 192:27]
  assign fsm_clock = clock;
  assign fsm_reset = reset;
  assign fsm_io_coin2Edge = _coin2Edge_T_1 & ~canEmpty & ~coinFull; // @[\\src\\main\\scala\\VendingMachine.scala 91:53]
  assign fsm_io_coin5Edge = _coin5Edge_T_1 & _coin2Edge_T_2 & _coin2Edge_T_4; // @[\\src\\main\\scala\\VendingMachine.scala 92:53]
  assign fsm_io_buyEdge = _buyEdge_T_1 & _coin2Edge_T_2; // @[\\src\\main\\scala\\VendingMachine.scala 93:38]
  assign fsm_io_buy = io_buy; // @[\\src\\main\\scala\\VendingMachine.scala 127:20]
  assign fsm_io_coin2 = io_coin2; // @[\\src\\main\\scala\\VendingMachine.scala 128:20]
  assign fsm_io_coin5 = io_coin5; // @[\\src\\main\\scala\\VendingMachine.scala 129:20]
  assign fsm_io_totalMoney = totalMoney; // @[\\src\\main\\scala\\VendingMachine.scala 130:21]
  assign fsm_io_itemPrice = {{3'd0}, _GEN_8}; // @[\\src\\main\\scala\\VendingMachine.scala 39:23]
  assign fsm_io_inpCoinBeingRej = fsm_io_inpCoinBeingRej_REG; // @[\\src\\main\\scala\\VendingMachine.scala 150:26]
  assign uart_clock = clock;
  assign uart_reset = reset;
  assign uart_io_sold = _T_25 & _coin2Edge_T_2; // @[\\src\\main\\scala\\VendingMachine.scala 222:58]
  assign uart_io_alarm = buyFallingEdge & fsm_io_alarm; // @[\\src\\main\\scala\\VendingMachine.scala 223:37]
  assign uart_io_empty = canEmpty & ~uart_io_empty_REG; // @[\\src\\main\\scala\\VendingMachine.scala 90:47]
  assign uart_io_full = showFull & ~uart_io_full_REG; // @[\\src\\main\\scala\\VendingMachine.scala 90:47]
  assign uart_io_rtnCoin = fsm_io_coinBeingRejected & ~uart_io_rtnCoin_REG; // @[\\src\\main\\scala\\VendingMachine.scala 90:47]
  always @(posedge clock) begin
    if (reset) begin // @[\\src\\main\\scala\\VendingMachine.scala 33:27]
      totalMoney <= 8'h0; // @[\\src\\main\\scala\\VendingMachine.scala 33:27]
    end else if (fsm_io_signalCoin2) begin // @[\\src\\main\\scala\\VendingMachine.scala 152:28]
      if (_T_21) begin // @[\\src\\main\\scala\\VendingMachine.scala 153:30]
        totalMoney <= _totalMoney_T_1; // @[\\src\\main\\scala\\VendingMachine.scala 154:18]
      end
    end else if (fsm_io_signalCoin5) begin // @[\\src\\main\\scala\\VendingMachine.scala 158:35]
      if (_T_23) begin // @[\\src\\main\\scala\\VendingMachine.scala 159:30]
        totalMoney <= _totalMoney_T_3; // @[\\src\\main\\scala\\VendingMachine.scala 160:18]
      end
    end else if (fsm_io_signalSub) begin // @[\\src\\main\\scala\\VendingMachine.scala 164:33]
      totalMoney <= _totalMoney_T_5; // @[\\src\\main\\scala\\VendingMachine.scala 165:16]
    end
    if (reset) begin // @[\\src\\main\\scala\\VendingMachine.scala 59:29]
      blinkCounter <= 32'h0; // @[\\src\\main\\scala\\VendingMachine.scala 59:29]
    end else if (blinkCounter == 32'h17d7840) begin // @[\\src\\main\\scala\\VendingMachine.scala 115:36]
      blinkCounter <= 32'h0; // @[\\src\\main\\scala\\VendingMachine.scala 116:18]
    end else begin
      blinkCounter <= _blinkCounter_T_1; // @[\\src\\main\\scala\\VendingMachine.scala 114:16]
    end
    if (reset) begin // @[\\src\\main\\scala\\VendingMachine.scala 60:25]
      blinkReg <= 1'h0; // @[\\src\\main\\scala\\VendingMachine.scala 60:25]
    end else if (blinkCounter == 32'h17d7840) begin // @[\\src\\main\\scala\\VendingMachine.scala 115:36]
      blinkReg <= ~blinkReg; // @[\\src\\main\\scala\\VendingMachine.scala 117:14]
    end
    if (reset) begin // @[\\src\\main\\scala\\VendingMachine.scala 63:23]
      cntReg <= 32'h0; // @[\\src\\main\\scala\\VendingMachine.scala 63:23]
    end else if (cntReg == 32'h1869f) begin // @[\\src\\main\\scala\\VendingMachine.scala 170:27]
      cntReg <= 32'h0; // @[\\src\\main\\scala\\VendingMachine.scala 171:12]
    end else begin
      cntReg <= _cntReg_T_1; // @[\\src\\main\\scala\\VendingMachine.scala 169:10]
    end
    if (reset) begin // @[\\src\\main\\scala\\VendingMachine.scala 64:23]
      selReg <= 2'h0; // @[\\src\\main\\scala\\VendingMachine.scala 64:23]
    end else if (cntReg == 32'h1869f) begin // @[\\src\\main\\scala\\VendingMachine.scala 170:27]
      selReg <= _selReg_T_1; // @[\\src\\main\\scala\\VendingMachine.scala 172:12]
    end
    if (reset) begin // @[\\src\\main\\scala\\VendingMachine.scala 68:27]
      coin2Count <= 6'h0; // @[\\src\\main\\scala\\VendingMachine.scala 68:27]
    end else if (fsm_io_signalCoin2 & totalMoney <= 8'h61) begin // @[\\src\\main\\scala\\VendingMachine.scala 137:50]
      coin2Count <= _coin2Count_T_1; // @[\\src\\main\\scala\\VendingMachine.scala 138:16]
    end
    if (reset) begin // @[\\src\\main\\scala\\VendingMachine.scala 69:27]
      coin5Count <= 6'h0; // @[\\src\\main\\scala\\VendingMachine.scala 69:27]
    end else if (fsm_io_signalCoin5 & totalMoney <= 8'h5e) begin // @[\\src\\main\\scala\\VendingMachine.scala 140:50]
      coin5Count <= _coin5Count_T_1; // @[\\src\\main\\scala\\VendingMachine.scala 141:16]
    end
    if (reset) begin // @[\\src\\main\\scala\\VendingMachine.scala 71:33]
      fullDisplayCount <= 4'h0; // @[\\src\\main\\scala\\VendingMachine.scala 71:33]
    end else if (blinkReg & ~REG_2 & showFull) begin // @[\\src\\main\\scala\\VendingMachine.scala 77:52]
      fullDisplayCount <= _fullDisplayCount_T_1; // @[\\src\\main\\scala\\VendingMachine.scala 78:22]
    end else if (_T_10 & coinFull | _T_13 & coinFull) begin // @[\\src\\main\\scala\\VendingMachine.scala 74:82]
      fullDisplayCount <= 4'ha; // @[\\src\\main\\scala\\VendingMachine.scala 75:22]
    end
    REG <= io_coin2; // @[\\src\\main\\scala\\VendingMachine.scala 90:58]
    REG_1 <= io_coin5; // @[\\src\\main\\scala\\VendingMachine.scala 90:58]
    REG_2 <= blinkReg; // @[\\src\\main\\scala\\VendingMachine.scala 77:28]
    if (reset) begin // @[\\src\\main\\scala\\VendingMachine.scala 83:25]
      canCount <= 5'h14; // @[\\src\\main\\scala\\VendingMachine.scala 83:25]
    end else if (buyFallingEdge & fsm_io_releaseCan & _coin2Edge_T_2) begin // @[\\src\\main\\scala\\VendingMachine.scala 144:58]
      canCount <= _canCount_T_1; // @[\\src\\main\\scala\\VendingMachine.scala 145:14]
    end
    buyFallingEdge_REG <= io_buy; // @[\\src\\main\\scala\\VendingMachine.scala 85:42]
    coin2Edge_REG <= io_coin2; // @[\\src\\main\\scala\\VendingMachine.scala 90:58]
    coin5Edge_REG <= io_coin5; // @[\\src\\main\\scala\\VendingMachine.scala 90:58]
    buyEdge_REG <= io_buy; // @[\\src\\main\\scala\\VendingMachine.scala 90:58]
    if (reset) begin // @[\\src\\main\\scala\\VendingMachine.scala 102:30]
      rejectCounter <= 32'h0; // @[\\src\\main\\scala\\VendingMachine.scala 102:30]
    end else if (rejectCounter == 32'h5f5e10) begin // @[\\src\\main\\scala\\VendingMachine.scala 106:38]
      rejectCounter <= 32'h0; // @[\\src\\main\\scala\\VendingMachine.scala 107:19]
    end else begin
      rejectCounter <= _rejectCounter_T_1; // @[\\src\\main\\scala\\VendingMachine.scala 105:17]
    end
    if (reset) begin // @[\\src\\main\\scala\\VendingMachine.scala 103:26]
      rejectReg <= 1'h0; // @[\\src\\main\\scala\\VendingMachine.scala 103:26]
    end else if (rejectCounter == 32'h5f5e10) begin // @[\\src\\main\\scala\\VendingMachine.scala 106:38]
      rejectReg <= ~rejectReg; // @[\\src\\main\\scala\\VendingMachine.scala 108:15]
    end
    if (reset) begin // @[\\src\\main\\scala\\VendingMachine.scala 150:36]
      fsm_io_inpCoinBeingRej_REG <= 1'h0; // @[\\src\\main\\scala\\VendingMachine.scala 150:36]
    end else if (fsm_io_signalCoin2) begin // @[\\src\\main\\scala\\VendingMachine.scala 152:28]
      if (_T_21) begin // @[\\src\\main\\scala\\VendingMachine.scala 153:30]
        fsm_io_inpCoinBeingRej_REG <= 1'h0; // @[\\src\\main\\scala\\VendingMachine.scala 149:31]
      end else begin
        fsm_io_inpCoinBeingRej_REG <= 1'h1; // @[\\src\\main\\scala\\VendingMachine.scala 156:18]
      end
    end else begin
      fsm_io_inpCoinBeingRej_REG <= _GEN_24;
    end
    uart_io_empty_REG <= canCount == 5'h0; // @[\\src\\main\\scala\\VendingMachine.scala 84:27]
    uart_io_full_REG <= fullDisplayCount > 4'h0; // @[\\src\\main\\scala\\VendingMachine.scala 72:35]
    uart_io_rtnCoin_REG <= fsm_io_coinBeingRejected; // @[\\src\\main\\scala\\VendingMachine.scala 90:58]
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE
