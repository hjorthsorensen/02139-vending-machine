...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  _blinkReg_T = ~blinkReg; // @[\\src\\main\\scala\\VendingMachine.scala 62:17]
  wire  _GEN_4 = coin2Edge ? 1'h0 : coin5Edge; // @[\\src\\main\\scala\\VendingMachine.scala 67:23 54:32]
  wire [7:0] _GEN_31 = {{3'd0}, io_price}; // @[\\src\\main\\scala\\VendingMachine.scala 74:25]
  wire  _T_2 = totalMoney >= _GEN_31; // @[\\src\\main\\scala\\VendingMachine.scala 74:25]
  ...
  wire [7:0] _totalMoney_T_5 = totalMoney - _GEN_31; // @[\\src\\main\\scala\\VendingMachine.scala 102:30]
  ...
  wire [3:0] _GEN_22 = 2'h3 == selReg ? 4'he : 4'hf; // @[\\src\\main\\scala\\VendingMachine.scala 112:18 126:19 43:32]
  wire [3:0] _GEN_23 = 2'h3 == selReg ? priceOnes : 4'h0; // @[\\src\\main\\scala\\VendingMachine.scala 112:18 127:27 44:23]
  ...
  wire [3:0] activeDigit = 2'h0 == selReg ? 4'h7 : _GEN_26; // @[\\src\\main\\scala\\VendingMachine.scala 112:18 114:19]
  wire  _T_11 = stateReg == 2'h2; // @[\\src\\main\\scala\\VendingMachine.scala 132:17]
  SevenSegDec sevSegDecoder ( // @[\\src\\main\\scala\\VendingMachine.scala 42:29]
    .io_in(sevSegDecoder_io_in),
    .io_out(sevSegDecoder_io_out)
  );
  assign io_releaseCan = stateReg == 2'h1; // @[\\src\\main\\scala\\VendingMachine.scala 140:30]
  assign io_alarm = _T_11 & blinkReg; // @[\\src\\main\\scala\\VendingMachine.scala 141:36]
  assign io_seg = ~sevSegDecoder_io_out; // @[\\src\\main\\scala\\VendingMachine.scala 138:13]
  assign io_an = stateReg == 2'h2 & _blinkReg_T ? 4'hf : activeDigit; // @[\\src\\main\\scala\\VendingMachine.scala 132:41 133:16 131:32]
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin // @[\\src\\main\\scala\\VendingMachine.scala 51:25]
      ...
      if (buyEdge) begin // @[\\src\\main\\scala\\VendingMachine.scala 73:21]
        if (totalMoney >= _GEN_31) begin // @[\\src\\main\\scala\\VendingMachine.scala 74:38]
